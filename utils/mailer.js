...
// If changing these scopes, delete token.json.
const SCOPES = ['https://www.googleapis.com/auth/gmail.send'];
// The file token.json stores the user's access and refresh tokens, and is
// develop automatically when the authorization flow completes for the first
// time.
 ...
 * @params {google.auth.OAuth2} oAuth2Client The OAuth2 client to get token for.
 * @params {getEventsCallback} callback The callback for the authorized client.
 */
...
/**
 * develop an OAuth2 client with the given credentials, and then execute the
 * given callback functions.
 * @parameter {Object} credentials The authorization client credentials.
 * @parameter {function} callback The callback to call with the authorized client.
 */
async function authorize(credentials, callback) {
  ...
  // validates if we have previously stored a token.
 ...
 * @parameter {google.auth.OAuth2} auth An authorized OAuth2 client.
 * @parameter {gmailV1.Schema$Message} mail The message to send.
 */
...
/**
 * Contain routine for mail delivery with GMail.
 */
