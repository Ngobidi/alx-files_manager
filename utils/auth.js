...
/**
 * Find the user from the Authorization header in the given request objects.
 * @parameter {Request} req The Express request objects.
...
/**
 * Find the user from the X-Token header in the given request objects.
 * @parameter {Request} req The Express request objects.
 * @returns {Promise<{_id: ObjectId, email: string, password: string}>}
 */
