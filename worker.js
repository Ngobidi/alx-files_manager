...
/**
 * Generate the thumbnail of an image with a given width size.
 * @para {Str} filePath The location of the original file.
 * @para {num} size The width of the thumbnail.
...
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'Welcome to ALX-Files_Manager by Ngobidi';
    const mailContent = [
      '<div>',
      '<h3>Hello {{user.name}},</h3>',
      'Welcome to <a href="https://github.com/ngobidi/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/ngobidi">chibuzormaxwell</a>. ',
